...
function Monitoring_DeviceComponent() {
  return (
    <>
      <div className="flex">
      <Sidebar>
        ...
        <Navbar>
            ...
            <Link to="/monitoring_device"><NavbarItem active={true}>Monitoring Device</NavbarItem></Link>
...
export default Monitoring_DeviceComponent;
