...
function Decom_ServerComponent() {
  return (
    <>
      <div className="flex">
      <Sidebar>
        ...
        <Navbar>
            <Link to ="/dc"><NavbarItem>DC</NavbarItem></Link>
            <Link to ="/dc_utility_equipment"><NavbarItem>DC Utility Equipment</NavbarItem></Link>
            <Link to ="/decom_server"><NavbarItem  active={true}>Decom Server</NavbarItem></Link>
            ...
            <Link to="/switch"><NavbarItem>Switch</NavbarItem></Link>
...
export default Decom_ServerComponent;
