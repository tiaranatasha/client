...
function Dc_Utility_EquipmentComponent() {
  return (
    <>
      <div className="flex">
      <Sidebar>
        ...
        <Navbar>
            <Link to ="/dc_utility_equipment"><NavbarItem active={true}>DC Utility Equipment</NavbarItem></Link>
...
export default Dc_Utility_EquipmentComponent;
